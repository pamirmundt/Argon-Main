...
*/
/**************************************************************************/
Adafruit_BNO055::Adafruit_BNO055(PinName SDA, PinName SCL, int32_t sensorID, uint8_t address) : _i2c(SDA, SCL)
{
  _sensorID = sensorID;
  _address = address;
...
*/
/**************************************************************************/
bool Adafruit_BNO055::write8(adafruit_bno055_reg_t reg, byte val)
{
    char value[2] = {(uint8_t)reg, (uint8_t)val};
    _i2c.write(_address, value, 2, false);
...
{
    char value[1] = {(uint8_t)reg};
    _i2c.write(_address, value, 1, true);
    _i2c.read(_address, value, 1, false);
...
{
    buffer[0] = reg;
    _i2c.write(_address, (char*)buffer, 1, true);
    _i2c.read(_address, (char*)buffer, len, false);
