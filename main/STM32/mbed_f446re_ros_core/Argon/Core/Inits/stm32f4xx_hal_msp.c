...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA9     ------> TIM1_CH2 
    */
    GPIO_InitStruct.Pin = motorEncoderA1_Pin|motorEncoderB1_Pin;
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PA7     ------> TIM3_CH2 
    */
    GPIO_InitStruct.Pin = motorEncoderA2_Pin|motorEncoderB2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB7     ------> TIM4_CH2 
    */
    GPIO_InitStruct.Pin = motorEncoderA3_Pin|motorEncoderB3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    PC7     ------> TIM8_CH2 
    */
    GPIO_InitStruct.Pin = motorEncoderA4_Pin|motorEncoderB4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = MotorPWM3_Pin|MotorPWM4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2 
    */
    HAL_GPIO_DeInit(GPIOA, motorEncoderA1_Pin|motorEncoderB1_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2 
    */
    HAL_GPIO_DeInit(GPIOA, motorEncoderA2_Pin|motorEncoderB2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2 
    */
    HAL_GPIO_DeInit(GPIOB, motorEncoderA3_Pin|motorEncoderB3_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2 
    */
    HAL_GPIO_DeInit(GPIOC, motorEncoderA4_Pin|motorEncoderB4_Pin);
