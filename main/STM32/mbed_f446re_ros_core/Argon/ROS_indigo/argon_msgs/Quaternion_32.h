#ifndef _ROS_argon_msgs_Quaternion_32_h
#define _ROS_argon_msgs_Quaternion_32_h
...
namespace argon_msgs
{
  ...
  class Quaternion_32 : public ros::Msg
  {
    public:
      float x;
      float y;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
     ...
     const char * getType(){ return "argon_msgs/Quaternion_32"; };
